...
int main(int argc, char** argv) {
    ...
    int num_threads = 8; //1, 2, 3, 4, 8, 16
    omp_set_num_threads(num_threads);
    //#pragma omp parallel for schedule(static) //4, 8
    //#pragma omp parallel for schedule(dynamic) //4, 8
    //#pragma omp parallel for schedule(guided) //4, 8
